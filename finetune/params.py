...
def get_finetune_params():
    ...
    parser.add_argument('--feat_layer',     type=str, default='5-11', help='The layers from which embeddings are fed to the classifier, e.g., 5-11 for taking out the 5th and 11th layers')
...
def get_finetune_params():
    ...
    # task settings
    parser.add_argument('--task_cfg_path',  type=str, default='/gladstone/finkbeiner/steve/work/data/npsad_data/monika/Antibodies_detection/finetune/task_configs/lbd.yaml', help='Path to the task configuration file')
    parser.add_argument('--exp_name',       type=str, default='monika_test1', help='Experiment name')
    parser.add_argument('--pat_strat',      action='store_true', default=True, help='Patient stratification')

    # input data settings
    parser.add_argument('--dataset_csv',    type=str, default='/gladstone/finkbeiner/steve/work/data/npsad_data/monika/Antibodies_detection/datasets/csv_files/data2.csv', help='Dataset csv file')
    parser.add_argument('--split_dir',      type=str, default='/gladstone/finkbeiner/steve/work/data/npsad_data/monika/Antibodies_detection/codes/prov-gigapath/data/antibodies_data/train_test_split', help='Split directory')
    parser.add_argument('--pre_split_dir',  type=str, default='', help='Specify the pre-split directory, if it is specified, we will skip automatic split')
    parser.add_argument('--root_path',      type=str, default='/gladstone/finkbeiner/steve/work/data/npsad_data/monika/Antibodies_detection/codes/prov-gigapath/data/antibodies_data/h5_files', help='The tile encodings path')
    parser.add_argument('--tile_size',      type=int, default=256, help='Tile size in pixels')
    parser.add_argument('--max_wsi_size',   type=int, default=262144, help='Maximum WSI size in pixels for the longer side (width or height).')
