...
#SBATCH --output=training_att.out    ## Output file
...
cd /gladstone/finkbeiner/steve/work/data/npsad_data/monika/Antibodies_detection/codes/prov-gigapath/scripts


sh run_antibody_test.sh
